...
class ImagePickerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val cardView: Int = parent.width / boardSize.getWidth()
        val cardHeight: Int = parent.height / boardSize.getHeight()
        val cardSideLength = min(cardView, cardHeight)
        val layoutParams: ViewGroup.LayoutParams = view.findViewById<ImageView>(R.id.imageView).layoutParams
